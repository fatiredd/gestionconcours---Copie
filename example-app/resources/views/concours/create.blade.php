...
<head>
    ...
    <style>
        ...
        /* Style pour changer la couleur du texte rempli */
        input[type="text"],
        textarea,
        input[type="date"] {
...
<div class="container mx-auto mt-24 py-8">
    <h1 class="text-5xl font-bold mb-4 text-center text-gray-800">Ajouter un Concours</h1>
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        <form action="{{ route('concours.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-input mt-1 block w-full" id="nom_concours" name="nom_concours" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="date" class="form-input mt-1 block w-full" id="date_debut" name="date_debut" required>
            </div>
            <div class="mb-4">
                <label for="date_fin" class="block text-gray-700 text-sm font-bold mb-2">Date du concours</label>
                <input type="date" class="form-input mt-1 block w-full" id="date_fin" name="date_fin" required>
            </div>

            <button type="submit" class="btn btn-salmon py-2 px-4 rounded">Ajouter</button>
        </form>
    </div>
</div>
</body>
